...
export const WidgetsScreen = ({navigation}) => {
  ...
  const [valueSecond, setValueSecond] = useState('EUR');
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.inner}>
        ...
        {/* <TouchableOpacity style={styles.buttonV} onPress={()=>{logOutHandler()}}>
          <Text style={styles.button}>Выйти из аккаунта</Text>
        </TouchableOpacity> */}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.separator}>
            ...
            <View>
              {convValue == null ? <Text style={{ fontSize: 18,  }}>0.00</Text> : <Text style={{ fontSize: 18,}}>{convValue}</Text>}
              ...
              <TouchableOpacity style={[styles.buttonV, {backgroundColor: THEME.MAIN_COLOR}]} onPress={()=>{ getCurrConvercy(valueFirst, valueSecond, valueCurrency, currency), console.log('button conv')}}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.separator}>
            {rssPost == null ? <ActivityIndicator size={'small'} color={THEME.MAIN_COLOR} /> : <PostsList />}
          </View>
        </View>
